...
def sanitize_filename(input_str):
    # Remove tudo o que está entre parênteses ou chaves
    input_str = re.sub(r'\([^)]*\)', '', input_str)
    input_str = re.sub(r'\{[^}]*\}', '', input_str)

    # Remove caracteres não permitidos em nomes de arquivo do Android
    input_str = re.sub(r'[^\w\-.]', '', input_str)

    # Limita o tamanho máximo do nome do arquivo para 100 caracteres
